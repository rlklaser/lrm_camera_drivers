...
#include <lrm_camera_drivers/split_node.h>

#include <dc1394/dc1394.h>
#include <cstring>

namespace lrm_camera_drivers {
...
void SplitBB2Nodelet::onInit() {
	...
	sub_ = it_->subscribe("camera/image_raw", 1, &SplitBB2Nodelet::imageCb, this, hints);
}
...
PLUGINLIB_EXPORT_CLASS(lrm_camera_drivers::SplitBB2Nodelet, nodelet::Nodelet)
